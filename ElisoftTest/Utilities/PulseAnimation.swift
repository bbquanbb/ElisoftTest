...
class PulseAnimation: CALayer {
    ...
    init(numberOfPulse: Float = Float.infinity, radius: CGFloat, postion: CGPoint, animationDuration: TimeInterval? = nil) {
        super.init()
    ...
    func scaleAnimation() -> CABasicAnimation {
        ...
        scaleAnimaton.toValue = NSNumber(value: 1.5)
